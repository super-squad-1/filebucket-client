...
/***/ (function(module, exports, __webpack_require__) {
	...
	var uploadEvents = __webpack_require__(52);
...
/***/ (function(module, exports) {
	...
	var config = {
	  apiOrigins: {
	    production: 'https://safe-retreat-33747.herokuapp.com',
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var showFiles = function showFiles(files) {
	  ...
	  files.forEach(function (e) {
	    var time = new Date(e.updatedAt);
	    var finalString = time.toLocaleDateString() + ' ' + time.toLocaleTimeString().replace(/:\d\d /, '');
	...
	var showConfirmDelete = function showConfirmDelete(id) {
	...
	var addHandlers = function addHandlers() {
	  ...
	  $('.navbar-div').on('click', '#show-upload-button', function () {
	    showUpload();
	  });

	  // event handler for clicking the 'update' button on a file
	  $('.content-div').on('click', '#each-file-update', function (event) {
	    var data = {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var map = {
		"./alert.handlebars": 10,
		"./files.handlebars": 30,
		"./form-auth.handlebars": 32,
		"./form-change-password.handlebars": 33,
		"./modal-confirm-delete.handlebars": 34,
		"./modal-update.handlebars": 35,
		"./modal-upload.handlebars": 36,
		"./nav-private.handlebars": 37,
		"./nav-public.handlebars": 38,
		"./not-used/file-delete.handlebars": 39,
		"./not-used/file-list.handlebars": 40,
		"./not-used/file-table.handlebars": 41,
		"./not-used/file-update.handlebars": 42,
		"./not-used/file-upload.handlebars": 43,
		"./not-used/get-files.handlebars": 44,
		"./not-used/sidebar.handlebars": 45
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams,depths) {
	  ...
	  return "    <tr data-id=\""
	    ...
	    + "\">\n      <td class=\"col-sm-6 col-xs-8\">\n        <span class=\"file-icon glyphicon glyphicon-file\"></span>\n        <a href=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.url : stack1), depth0))
	    + "\" class=\"btn btn-link file-name\" target=\"_blank\">"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.name : stack1), depth0))
	    + "</a>\n      </td>\n      <td class=\"file-date file-date-created col-sm-2 hidden-xs\">"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.createdAt : stack1), depth0))
	    + "</td>\n      <td class=\"file-date file-date-modified col-sm-2 col-xs-2\">"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.updatedAt : stack1), depth0))
	    + "</td>\n      <td class=\"col-sm-2 col-xs-2 text-right\">\n"
	    + ((stack1 = __default(__webpack_require__(31)).call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.owner : depth0),{"name":"isOwner","hash":{"owner":((stack1 = blockParams[0][0]) != null ? stack1._owner : stack1),"user":((stack1 = (depths[1] != null ? depths[1].data : depths[1])) != null ? stack1.userID : stack1)},"fn":container.program(2, data, 0, blockParams, depths),"inverse":container.program(4, data, 0, blockParams, depths),"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + "      </td>\n    </tr>\n";
	},"2":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1;

	  return "          <div class=\"btn-group\">\n            <button class=\"btn btn-default\" id=\"each-file-delete\">\n              <i class=\"glyphicon glyphicon-trash\"></i>\n            </button>\n            <button class=\"btn btn-default\" id=\"each-file-update\">\n              <i class=\"glyphicon glyphicon-pencil\"></i>\n            </button>\n            <a href=\""
	    + container.escapeExpression(container.lambda(((stack1 = blockParams[1][0]) != null ? stack1.url : stack1), depth0))
	    + "\" class=\"btn btn-primary\" id=\"each-file-download\" download>\n              <i class=\"glyphicon glyphicon-download-alt\"></i>\n            </a>\n          </div>\n";
	  ...
	  return "<table class=\"table table-hover\">\n  <thead>\n    <tr>\n      <th class=\"file-item file-name col-sm-6 col-xs-8\">\n        <span class=\"glyphicon glyphicon-th-list\"></span>\n        <strong></strong>\n      </th>\n      <th class=\"file-item file-date col-sm-2 hidden-xs\">\n        <strong>Created</strong>\n      </th>\n      <th class=\"file-item file-date col-sm-2 col-xs-2\">\n        <strong>Modified</strong>\n      </th>\n      <th class=\"col-sm-2 col-xs-2\">\n      </th>\n    </tr>\n  </thead>\n  <tbody>\n"
	    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),((stack1 = (depth0 != null ? depth0.data : depth0)) != null ? stack1.files : stack1),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams, depths),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + "  </tbody>\n</table>\n";
...
/***/ (function(module, exports) {
	...
	var isOwner = function isOwner(conditional, options) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<div id=\"update-modal\" class=\"modal fade\" role=\"dialog\">\n  <div class=\"modal-dialog modal-md\">\n    <div class=\"modal-content\">\n      <div class=\"modal-header\">\n        <button type=\"button\" class=\"close\" data-dismiss=\"modal\">&times;</button>\n        <h4 class=\"modal-title\">Update File Title</h4>\n      </div>\n      <div class=\"modal-body\">\n        <form id=\"update-file\" class=\"form\" data-id="
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.file : depth0)) != null ? stack1.id : stack1), depth0))
	    + ">\n          <fieldset>\n            <div class=\"form-group\">\n              <label for=\"file-update-title\" class=\"sr-only\">Title</label>\n              <div class=\"input-group\">\n                <input id=\"file-update-title\" class=\"form-control\" type=\"text\" placeholder=\"Choose a file...\" name=\"upload[name]\" value=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.file : depth0)) != null ? stack1.title : stack1), depth0))
	    + "\">\n              </div>\n              <p class=\"help-block\">Please enter an file title.</p>\n            </div>\n            <div class=\"form-group text-center\">\n              <button type=\"button\" class=\"btn btn-default\" data-dismiss=\"modal\"><span class=\"glyphicon glyphicon-remove\"></span> Cancel</button>\n              <button type=\"submit\" class=\"btn btn-primary\"><span class=\"glyphicon glyphicon-cloud-upload\"></span> Update</button>\n            </div>\n          </fieldset>\n        </form>\n      </div>\n    </div>\n  </div>\n</div>\n";
	},"useData":true});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    return "<div id=\"upload-modal\" class=\"modal fade\" role=\"dialog\">\n  <div class=\"modal-dialog modal-md\">\n    <div class=\"modal-content\">\n      <div class=\"modal-header\">\n        <button type=\"button\" class=\"close\" data-dismiss=\"modal\">&times;</button>\n        <h4 class=\"modal-title\">Upload a File</h4>\n      </div>\n      <div class=\"modal-body\">\n        <form id=\"multipart-form-data\" enctype=\"multipart/form-data\" class=\"form\">\n          <fieldset>\n            <div class=\"form-group\">\n              <label for=\"file-upload-title\" class=\"sr-only\">Title</label>\n              <div class=\"input-group\">\n                <input id=\"file-upload-title\" class=\"form-control\" type=\"text\" placeholder=\"Choose a file...\" name=\"file[name]\">\n                <div class=\"input-group-btn\">\n                  <label class=\"file-upload btn btn-primary\">\n                    <span><i class=\"glyphicon glyphicon-file\"></i> Choose File</span>\n                    <input id=\"file-selector\" type=\"file\" class=\"upload\" name=\"file[path]\"/>\n                  </label>\n                </div>\n              </div>\n              <p class=\"help-block\">Make sure to name your file</p>\n            </div>\n            <div class=\"form-group text-center\">\n              <button type=\"button\" class=\"btn btn-default\" data-dismiss=\"modal\"><span class=\"glyphicon glyphicon-remove\"></span> Cancel</button>\n              <button type=\"submit\" class=\"btn btn-primary\"><span class=\"glyphicon glyphicon-cloud-upload\"></span> Upload</button>\n            </div>\n          </fieldset>\n        </form>\n      </div>\n    </div>\n  </div>\n</div>\n";
	},"useData":true});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<div class=\"container\">\n  <div class=\"navbar-header\">\n    <button type=\"button\" class=\"navbar-toggle collapsed\" data-toggle=\"collapse\" data-target=\"#navbar-collapse\">\n      <span class=\"sr-only\">Toggle navigation</span>\n      <span class=\"icon-bar\"></span>\n      <span class=\"icon-bar\"></span>\n      <span class=\"icon-bar\"></span>\n    </button>\n    <span class=\"navbar-brand\">FileBucket</span>\n  </div>\n  <div class=\"collapse navbar-collapse\" id=\"navbar-collapse\">\n    <ul class=\"nav navbar-nav navbar-right\">\n      <li>\n        <a href=\"#\" type=\"button\" class=\"btn btn-link\" id=\"show-upload-button\"><span class=\"glyphicon glyphicon-cloud-upload\"></span> Upload</a>\n      </li>\n      <li class=\"dropdown\">\n        <a href=\"#\" type=\"button\" class=\"btn btn-link dropdown-toggle\" data-toggle=\"dropdown\" id=\"change-password-nav\"><span class=\"glyphicon glyphicon-user\"></span> Change Password <span class=\"caret\"></span></a>\n        <div id=\"change-password-dropdown\" class=\"dropdown-menu\">\n"
	    + ((stack1 = container.invokePartial(__webpack_require__(33),depth0,{"name":"form-change-password","data":data,"indent":"            ","helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "")
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    return "<form id=\"file-delete\" class=\"form form-inline\">\n  <fieldset>\n    <legend>File Delete</legend>\n    <div class=\"form-group\">\n      <label for=\"file-delete-id\" class=\"sr-only\">File ID</label>\n      <!-- <div class=\"input-group\"> -->\n        <input type=\"text\" class=\"form-control\" name=\"file[id]\" id=\"file-delete-id\" placeholder=\"ID\" value=\"\">\n      <!-- </div> -->\n    </div>\n\n    <button type=\"submit\" class=\"btn btn-primary\"><span class=\"glyphicon glyphicon-trash\"></span> Delete</button>\n\n  </fieldset>\n</form>\n";
	},"useData":true});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    return "<div class=\"panel panel-default\">\n  <!-- Default panel contents -->\n  <div class=\"panel-heading\" style=\"overflow:hidden\">\n    <span class=\"file-item file-name col-sm-8 col-xs-8\">\n      <span class=\"glyphicon glyphicon-th-list\"></span>\n      <strong></strong>\n    </span>\n    <span class=\"file-item file-date col-sm-2 hidden-xs\">\n      <strong>Created</strong>\n    </span>\n    <span class=\"file-item file-date col-sm-2 col-xs-4\">\n      <strong>Modified</strong>\n    </span>\n  </div>\n  <!-- <div class=\"panel-body\">\n    <p>...</p>\n  </div> -->\n  <!-- List group -->\n  <div class=\"list-group\">\n    <a href=\"#\" class=\"list-group-item\" style=\"overflow:hidden\">\n      <span class=\"file-name col-sm-8 col-xs-8\">\n        <span class=\"file-icon glyphicon glyphicon-folder-open\"></span>\n        <button class=\"btn btn-link\">Folder Name</button>\n      </span>\n      <span class=\"file-date-created col-sm-2 hidden-xs\">05-20-2017</span>\n      <span class=\"file-date-modified col-sm-2 col-xs-4\">05-20-2017</span>\n    </a>\n    <a href=\"#\" class=\"list-group-item\" style=\"overflow:hidden\">\n      <span class=\"file-name col-sm-8 col-xs-8\">\n        <span class=\"file-icon glyphicon glyphicon-file\"></span>\n        <button class=\"btn btn-link\">File Name</button>\n      </span>\n      <span class=\"file-date-created col-sm-2 hidden-xs\">05-20-2017</span>\n      <span class=\"file-date-modified col-sm-2 col-xs-4\">05-20-2017</span>\n    </a>\n    <a href=\"#\" class=\"list-group-item\" style=\"overflow:hidden\">\n      <span class=\"file-name col-sm-8 col-xs-8\">\n        <span class=\"file-icon glyphicon glyphicon-file\"></span>\n        <button class=\"btn btn-link\">File Name</button>\n      </span>\n      <span class=\"file-date-created col-sm-2 hidden-xs\">05-20-2017</span>\n      <span class=\"file-date-modified col-sm-2 col-xs-4\">05-20-2017</span>\n    </a>\n  </div>\n</div>\n";
	},"useData":true});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    return "<table class=\"table table-hover\">\n  <thead>\n    <tr>\n      <th class=\"file-item file-name col-sm-8 col-xs-8\">\n        <span class=\"glyphicon glyphicon-th-list\"></span>\n        <strong></strong>\n      </th>\n      <th class=\"file-item file-date col-sm-2 hidden-xs\">\n        <strong>Created</strong>\n      </th>\n      <th class=\"file-item file-date col-sm-2 col-xs-4\">\n        <strong>Modified</strong>\n      </th>\n    </tr>\n  </thead>\n  <tbody>\n    <tr>\n      <td class=\"file-name col-sm-8 col-xs-8\">\n        <span class=\"file-icon glyphicon glyphicon-folder-open\"></span>\n        <button class=\"btn btn-link\">Folder Name</button>\n      </td>\n      <td class=\"file-date file-date-created col-sm-2 hidden-xs\">05-20-2017</td>\n      <td class=\"file-date file-date-modified col-sm-2 col-xs-4\">05-20-2017</td>\n      <td class=\"file-date file-date-modified col-sm-2 col-xs-4\"><button class=\"glyphicon glyphicon-trash\" id=\"each-file-delete\"></button></td>\n      <td class=\"file-date file-date-modified col-sm-2 col-xs-4\"><button class=\"glyphicon glyphicon-pencil\" id=\"each-file-update\"></button></td>\n      <td class=\"file-date file-date-modified col-sm-2 col-xs-4\"><button class=\"glyphicon glyphicon-download-alt\"id=\"each-file-download\"></button></td>\n\n    </tr>\n    <tr>\n      <td class=\"file-name col-sm-8 col-xs-8\">\n        <span class=\"file-icon glyphicon glyphicon-file\"></span>\n        <button class=\"btn btn-link\">File Name</button>\n      </td>\n      <td class=\"file-date file-date-created col-sm-2 hidden-xs\">05-20-2017</td>\n      <td class=\"file-date file-date-modified col-sm-2 col-xs-4\">05-20-2017</td>\n      <td class=\"file-date file-date-modified col-sm-2 col-xs-4\"><button class=\"glyphicon glyphicon-trash\" id=\"each-file-delete\"></button></td>\n      <td class=\"file-date file-date-modified col-sm-2 col-xs-4\"><button class=\"glyphicon glyphicon-pencil\" id=\"each-file-update\"></button></td>\n      <td class=\"file-date file-date-modified col-sm-2 col-xs-4\"><button class=\"glyphicon glyphicon-download-alt\"id=\"each-file-download\"></button></td>\n    </tr>\n    <tr>\n      <td class=\"file-name col-sm-8 col-xs-8\">\n        <span class=\"file-icon glyphicon glyphicon-file\"></span>\n        <button class=\"btn btn-link\">File Name</button>\n      </td>\n      <td class=\"file-date file-date-created col-sm-2 hidden-xs\">05-20-2017</td>\n      <td class=\"file-date file-date-modified col-sm-2 col-xs-4\">05-20-2017</td>\n      <td class=\"file-date file-date-modified col-sm-2 col-xs-4\"><button class=\"glyphicon glyphicon-trash\" id=\"each-file-delete\"></button></td>\n      <td class=\"file-date file-date-modified col-sm-2 col-xs-4\"><button class=\"glyphicon glyphicon-pencil\" id=\"each-file-update\"></button></td>\n      <td class=\"file-date file-date-modified col-sm-2 col-xs-4\"><button class=\"glyphicon glyphicon-download-alt\" id=\"each-file-download\"></button></td>\n    </tr>\n  </tbody>\n</table>\n";
	},"useData":true});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    return "<form id=\"file-update\" class=\"form form-inline\">\n  <fieldset>\n    <legend>File Update</legend>\n    <div class=\"form-group\">\n      <label for=\"file-update-id\" class=\"sr-only\">File ID</label>\n      <!-- <div class=\"input-group\"> -->\n        <input type=\"text\" class=\"form-control\" name=\"file[id]\" id=\"file-update-id\" placeholder=\"ID\" value=\"\">\n      <!-- </div> -->\n    </div>\n    <div class=\"form-group\">\n      <label for=\"file-update-title\" class=\"sr-only\">Title</label>\n      <!-- <div class=\"input-group\"> -->\n        <input type=\"text\" class=\"form-control\" name=\"file[title]\" id=\"file-upload-update\" placeholder=\"Title\" value=\"\">\n      <!-- </div> -->\n    </div>\n    <button type=\"submit\" class=\"btn btn-primary\"><span class=\"glyphicon glyphicon-edit\"></span> Update</button>\n\n  </fieldset>\n</form>\n";
	},"useData":true});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    return "<form id=\"multipart-form-data\" enctype=\"multipart/form-data\" class=\"form form-inline\">\n  <fieldset>\n    <legend>File Upload</legend>\n    <p>enctype=\"multipart/form-data\"</p>\n    <div class=\"form-group\">\n      <label for=\"file-upload-title\" class=\"sr-only\">Title</label>\n        <input type=\"text\" class=\"form-control\" name=\"name\" id=\"file-upload-title\" placeholder=\"Title\" value=\"\">\n    </div>\n    <div class=\"form-group\">\n      <label class=\"btn btn-primary\" for=\"file-upload-select\">\n        <input id=\"file-upload-select\"\n          type=\"file\"\n          name=\"name\"\n          style=\"display:none;\">\n        Choose File\n      </label>\n    </div>\n\n    <button type=\"submit\" class=\"btn btn-primary\"><span class=\"glyphicon glyphicon-cloud-upload\"></span> Upload</button>\n\n    <span id=\"upload-file-info\"></span>\n\n  </fieldset>\n</form>\n";
	},"useData":true});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    return "<button type=\"button\" id=\"get-files\" data-loading-text=\"Loading...\" class=\"btn btn-primary\" autocomplete=\"off\">\n  Get Files\n</button>\n";
	},"useData":true});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var getFormFields = __webpack_require__(47);
	// api and ui methods for authentication
	var authApi = __webpack_require__(48);
	var authUi = __webpack_require__(49);
	// api and ui methods for authentication
	var uploadApi = __webpack_require__(50);
	var uploadUi = __webpack_require__(51);
	  ...
	  if (!data.credentials.email) {
	    ...
	    .then(function () {
	      authApi.signIn(data).then(authUi.signInSuccess).then(function () {
	        uploadApi.getFiles().then(uploadUi.getFilesSuccess).catch(uploadUi.getFilesFailure);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var downloadFile = function downloadFile(data) {
	  return $.ajax({
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var deleteFileFailure = function deleteFileFailure() {
	  view.showAlert('error', 'Your file could not be deleted');
	};

	var getFilesSuccess = function getFilesSuccess(response) {
	  view.showFiles(response.uploads);
	};

	var getFilesFailure = function getFilesFailure() {
	  view.showAlert('error', 'Hmmm. Couldn\'t get your list of files...');
	};

	var uploadFileSuccess = function uploadFileSuccess(data) {
	  // view.showAlert(`message`, `Your file has been uploaded.`)
	  $('#upload-modal').modal('hide');
	};

	var uploadFileFailure = function uploadFileFailure() {
	  view.showAlert('error', 'Your file could not be uploaded.');
	};

	var updateFileSuccess = function updateFileSuccess() {
	  // view.showAlert(`message`, `Your file has been updated.`)
	  $('#update-modal').modal('hide');
	};

	var updateFileFailure = function updateFileFailure() {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var createUploadMultiPart = function createUploadMultiPart(event) {
	  ...
	  if (!data.get('file[name]')) {
	    ...
	    uploadApi.createMulti(data).then(uploadUi.uploadFileSuccess).then(function () {
	      uploadApi.getFiles().then(uploadUi.getFilesSuccess).then(function () {
	        view.showAlert('message', 'Your file has been uploaded');
	...
	var onDelete = function onDelete(event) {
	  ...
	  if (dataId.length !== 0) {
	    uploadApi.deleteFile(dataId).then(uploadUi.deleteFileSuccess).then(function () {
	      uploadApi.getFiles().then(uploadUi.getFilesSuccess).then(function () {
	        view.showAlert('message', 'Your file has been deleted');
	      }).catch(uploadUi.getFilesFailure);
	...
	var onUpdate = function onUpdate(event) {
	  ...
	  if (!data.upload.name) {
	    ...
	    uploadApi.updateFile(data).then(uploadUi.updateFileSuccess).then(function () {
	      uploadApi.getFiles().then(uploadUi.getFilesSuccess).then(function () {
	        view.showAlert('message', 'Your file has been updated.');
	      }).catch(uploadUi.getFilesFailure);
	...
	var onGetFiles = function onGetFiles() {
	  uploadApi.getAllFiles().then(uploadUi.getFilesSuccess).catch(uploadUi.getFilesFailure);
	};
	...
	var addHandlers = function addHandlers() {
	  ...
	  $('body').on('change', '#file-selector', function () {
